...
class JSON_API_Core_Controller {
  ...
  public function get_page() {
    ...
    if ($id || $page_id) {
      ...
      $json_api->error("Include 'id' or 'slug' var in your request.",404);
    }
  ...
  public function get_nonce() {
    ...
    if ($controller && $method) {
      ...
      $json_api->error("include 'controller' and 'method' vars in your request",303);
    }
  }
  ...
  protected function get_object_posts($object, $id_var, $slug_var) {
    ...
    if ($id || $$object_id) {
      ...
      $json_api->error("No $type specified. Include 'id' or 'slug' var in your request.",201);
    }
    return $posts;
  }
