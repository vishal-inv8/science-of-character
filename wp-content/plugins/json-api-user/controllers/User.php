...
public function retrieve_password()
{
  ...
  if ( strpos( $user_login, '@' ) ) {
	 ...
	 $json_api->error("Your email address was not found. Please try again.");
...
$forgot_img_path = $wp_upload_dir['baseurl'].'/forgot-images';
$forgot_fnt_path = $wp_upload_dir['baseurl'].'/forgot-fonts';
...
<title>Science of Character</title>
<style type='text/css'>	
@font-face {
    font-family: 'sf_compact_displayregular';
    src: url('".$forgot_fnt_path."/sfcompactdisplay-regular-webfont.eot');
    src: url('".$forgot_fnt_path."/sfcompactdisplay-regular-webfont.eot?#iefix') format('embedded-opentype'),
    url('".$forgot_fnt_path."/sfcompactdisplay-regular-webfont.woff2') format('woff2'),
    url('".$forgot_fnt_path."/sfcompactdisplay-regular-webfont.woff') format('woff'),
    url('".$forgot_fnt_path."/sfcompactdisplay-regular-webfont.ttf') format('truetype'),
    url('".$forgot_fnt_path."/sfcompactdisplay-regular-webfont.svg#sf_compact_displayregular') format('svg');
    font-weight: normal;
    font-style: normal;
}
@font-face
{
    ...
    src: url('".$forgot_fnt_path."/sfcompactdisplay-medium-webfont.eot');
    src: url('".$forgot_fnt_path."/sfcompactdisplay-medium-webfont.eot?#iefix') format('embedded-opentype'),
    url('".$forgot_fnt_path."/sfcompactdisplay-medium-webfont.woff2') format('woff2'),
    url('".$forgot_fnt_path."/sfcompactdisplay-medium-webfont.woff') format('woff'),
    url('".$forgot_fnt_path."/sfcompactdisplay-medium-webfont.ttf') format('truetype'),
    url('".$forgot_fnt_path."/sfcompactdisplay-medium-webfont.svg#sf_compact_displaymedium') format('svg');
    font-weight: normal;
    font-style: normal;
}
</style>
    ...
    <table border='0' style='font-family:'sf_compact_displayregular', Arial, Helvetica, sans-serif;padding-top:20px; padding-bottom:20px; outline:none; border:none; width:100%; font-size:15px;color:#333; margin:0 auto; line-height:24px; width:540px;'>
      <tr>
        <td colspan='3' align='left'><a href='#'><img border='0' width='540' alt='' src='".$forgot_img_path."/EhAYBwlPjh-forgot-password-email-graphic-header.png'> </a></td>
      </tr>
            <tr>
        	<td colspan='3' align='left' style='text-align:center;padding:40px 0 20px 0;'><h1 style='font-size:20px; margin:0; padding:0; color:#000;font-family: 'sf_compact_displaymedium';  '>App Password Reset Request </h1></td>
      		</tr>
            <tr>
        	<td colspan='3'  style='text-align:center;padding-bottom: 20px;'><p style='font-size:16px; margin:0; padding:0;' >Someone requested that the  password be reset for the following account:</p></td>
      		</tr>
            
            <tr>
        	<td colspan='3' align='left' style='text-align:left; padding:0 0 15px 80px;'>Account: Character (Every) Day App<br> Username: ".$user_login."</td>
      		</tr>
  
            
            <tr>
            <td colspan='3' align='left' style='text-align:left;'>To reset your password follow the link bellow:</td>
            </tr>
            
            <tr>
            <td colspan='3' align='left' style='text-align:left;padding-bottom: 20px;'><a href='".network_site_url("wp-login.php?action=rp&key=$key&login=" . rawurlencode($user_login), 'login')."' style='color:blue;'>".network_site_url("wp-login.php?action=rp&key=$key&login=" . rawurlencode($user_login), 'login')."</a></td>
            </tr>
            <tr>
            <td colspan='3' align='left' style='text-align:left;padding-bottom: 20px;'>
            If this was a mistake, ignore this email and nothing will happen.
            </td>
	    </tr>
	    <tr>
            <td colspan='3' align='left' style='text-align:left;padding-bottom: 20px;'>Thank You,<br>
			Character (Every) Day App Team</td>
            </tr>
            <tr>
            <td colspan='3'  align='center'><a href='#'><img border='0' width='130' alt='' src='".$forgot_img_path."/design.png'> </a></td>
          </tr>
    </table>
</body>
</html>";
	...
	$title = sprintf( __('Character (Every) Day Password Reset'), $blogname );	
...
$sitename = strtolower( $_SERVER['SERVER_NAME'] );
	...
	$sitename = substr( $sitename, 4 );
        ...
        $headers = array('From: WordPress <wordpress@'.$sitename.'>');
    ...
    else
    {
        ...
        return array(
        "msg" => 'We have emailed you a link to reset your password. The link will be expire in one hour.',
        'code'=>247
	);
    }
}
...
public function get_user_meta() {
		...
		else
		{
				...
				$data = array_filter( array_map( function( $a ) { return $a[0]; }, $meta ) );
		}
	   return $data;
}
